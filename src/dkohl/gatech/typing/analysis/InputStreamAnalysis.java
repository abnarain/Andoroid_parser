...
/**
 * IMPLEMENTS: "Analyzing the Input Stream for CharacterLevel Errors in Unconstrained Text
 * Entry Evaluations", Wobbrock, Myers, ACM Transactions on Computer-Human Interaction,
 * Vol. 13, No. 4, December 2006, Pages 458–489
 * 
 * REPUIRES: Data from users typing, in particular:
 * 	PRESENTED_STRING: What the users' were supposed to type
 * 	INPUT_STRIM: What the users did type with annotations like ('<': for back space, '!' for error or '#' for enter)
 * 	TRANSCRIBED_STRING: The final version of what the user typed (no annotations, all back spaces applied) 
 * 
 * @author Daniel Kohlsdorf
 */
public class InputStreamAnalysis {
